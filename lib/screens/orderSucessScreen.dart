...
import 'package:grocery_mobile_app/screens/trackOrderScreen.dart';
...
class OrderSuccessScreen extends BaseRoute {
  OrderSuccessScreen({a, o}) : super(a: a, o: o, r: 'OrderSuccessScreen');
  @override
  _OrderSuccessScreenState createState() => new _OrderSuccessScreenState();
}

class _OrderSuccessScreenState extends BaseRouteState {
  _OrderSuccessScreenState() : super();
            ...
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    ...
                    child: Text(
                        '${AppLocalizations.of(context).btn_track_order}',
                        style: TextStyle(
                            fontSize: 14,
                            color: Colors.black,
